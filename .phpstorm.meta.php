...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/mohamad/Desktop/resumetowebsite/public/storage' => 'string',
            ...
            'portfolio.resume.skills.0.skill' => 'string',
            'portfolio.resume.hobbies.0.hobby' => 'string',
            'portfolio.resume.location.0.city' => 'string',
            'portfolio.resume.location.0.state' => 'string',
            'portfolio.resume.location.0.address' => 'string',
            'portfolio.resume.location.0.country' => 'string',
            'portfolio.resume.location.0.zipCode' => 'string',
            'portfolio.resume.projects.0.project' => 'string',
            'portfolio.resume.education.0.degree' => 'string',
            'portfolio.resume.education.0.details' => 'string',
            'portfolio.resume.education.0.institution' => 'string',
            'portfolio.resume.education.0.graduationDate' => 'string',
            'portfolio.resume.socialLinks.0.other' => 'string',
            'portfolio.resume.socialLinks.0.github' => 'string',
            'portfolio.resume.socialLinks.0.twitter' => 'string',
            'portfolio.resume.socialLinks.0.linkedin' => 'string',
            'portfolio.resume.socialLinks.0.instagram' => 'string',
            'portfolio.resume.achievements.0.achievement' => 'string',
            'portfolio.resume.personalInfo.0.email' => 'string',
            'portfolio.resume.personalInfo.0.mobile' => 'string',
            'portfolio.resume.personalInfo.0.website' => 'string',
            'portfolio.resume.personalInfo.0.lastName' => 'string',
            'portfolio.resume.personalInfo.0.firstName' => 'string',
            'portfolio.resume.workExperience.0.role' => 'string',
            'portfolio.resume.workExperience.0.company' => 'string',
            'portfolio.resume.workExperience.0.endDate' => 'string',
            'portfolio.resume.workExperience.0.startDate' => 'string',
            'portfolio.resume.workExperience.0.description' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./home/mohamad/Desktop/resumetowebsite/public/storage','gemini.api_key','gemini.base_url','gemini.request_timeout',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','portfolio.resume.skills.0.skill','portfolio.resume.hobbies.0.hobby',
'portfolio.resume.location.0.city','portfolio.resume.location.0.state','portfolio.resume.location.0.address','portfolio.resume.location.0.country','portfolio.resume.location.0.zipCode',
'portfolio.resume.projects.0.project','portfolio.resume.education.0.degree','portfolio.resume.education.0.details','portfolio.resume.education.0.institution','portfolio.resume.education.0.graduationDate',
'portfolio.resume.socialLinks.0.other','portfolio.resume.socialLinks.0.github','portfolio.resume.socialLinks.0.twitter','portfolio.resume.socialLinks.0.linkedin','portfolio.resume.socialLinks.0.instagram',
'portfolio.resume.achievements.0.achievement','portfolio.resume.personalInfo.0.email','portfolio.resume.personalInfo.0.mobile','portfolio.resume.personalInfo.0.website','portfolio.resume.personalInfo.0.lastName',
'portfolio.resume.personalInfo.0.firstName','portfolio.resume.workExperience.0.role','portfolio.resume.workExperience.0.company','portfolio.resume.workExperience.0.endDate','portfolio.resume.workExperience.0.startDate',
'portfolio.resume.workExperience.0.description','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'session.same_site','session.partitioned','boost.enabled','boost.browser_logs_watcher','log-viewer.enabled',
...
'boost.browser-logs','log-viewer.hosts','log-viewer.folders','log-viewer.folders.request-download','log-viewer.folders.clear-cache',
...
'log-viewer.index','home','language.switch','dashboard',
'dashboard.resume.get','dashboard.resume.destroy','dashboard.resume.update','dashboard.resume.save','dashboard.import',
'settings.language','register','register.store','login','login.store',
'password.request','password.email','password.reset','password.store','verification.notice',
'verification.verify','verification.send','password.confirm','password.confirm.store','logout','profile.edit','profile.update','profile.destroy','password.edit',
'password.update','appearance','storage.local',);
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','GEMINI_API_KEY',);
