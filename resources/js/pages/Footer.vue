...
import { Github, Book, Heart } from 'lucide-vue-next';
        ...
        <div class="space-y-4">
          ...
          <ul class="space-y-2">
            <li v-for="link in links.community" :key="link.text">
              <a :href="link.href" class="text-sm hover:text-foreground" target="_blank" rel="noopener noreferrer">{{
                link.text
              }}</a>
            </li>
          </ul>
    ...
    <div class="border-t border-border py-4">
      <div class="container mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-4">
          <a href="https://github.com/Masri-Programmer/resumetowebsite.git" target="_blank" rel="noopener noreferrer" aria-label="GitHub Repository">
