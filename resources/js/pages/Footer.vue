...
<template>
  <footer class="w-full border-t border-border bg-background">
        ...
        <div class="space-y-4">
          ...
          <ul class="space-y-2">
            <li v-for="link in links.community" :key="link.text">
              <a :href="link.href" class="text-sm  hover:text-foreground" target="_blank">{{
                link.text
              }}</a>
            </li>
          </ul>
    ...
    <div class="border-t border-border py-3">
      <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-between sm:flex-row ">
